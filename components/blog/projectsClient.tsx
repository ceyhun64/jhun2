...
export default function ProjectsClient({ dict, locale }: Props) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-black via-amber-900 to-black text-white py-15 md:py-20 px-4 md:px-10 relative overflow-hidden">
            ...
            {projects.map((proj, index) => (
              ...
              >
                {isMobile ? (
                  ...
                  >
                    <CardBody className="relative bg-linear-to-b from-zinc-950/50 to-zinc-900/70 border border-zinc-800/70 rounded-2xl p-3 group/card hover:border-blue-500/40 transition-all duration-500 hover:shadow-[0_0_25px_rgba(59,130,246,0.25)] hover:z-10 text-left">
      ...
      >
        <div className="relative inline-block px-10 py-8 rounded-3xl bg-linear-to-br from-[#0a0f1f] via-[#101a3b] to-[#1e2b4b] border border-indigo-900/30 shadow-[0_0_50px_rgba(24,39,94,0.5)] hover:shadow-[0_0_80px_rgba(60,90,180,0.7)] transition-all duration-700 backdrop-blur-md">
          <h2 className="text-3xl md:text-5xl font-extrabold font-mono text-transparent bg-clip-text bg-linear-to-r from-sky-300 via-indigo-300 to-blue-100 drop-shadow-[0_0_15px_rgba(90,160,255,0.3)]">
            {dict.cta_title}
          </h2>
